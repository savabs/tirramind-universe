...
Built 2026-09-21T22:44:18+00:00 by tirramind 0.1.0. Derived from SEC public
...
| file | rows | what |
|---|---|---|
| `tickers_latest.parquet` | 10459 | current (cik, ticker, name, exchange) |
| `events.parquet` | 104268 | every change between consecutive snapshots |
| `delistings.parquet` | 14358 | permanent removals (not re-listed, not from a suspect capture) with a cause and evidence accessions |
| `filings.parquet` | 78825 | Form 25 / 15 and item-filtered 8-K filings, 2015→ |

## Events (273 snapshots, 2017-08-28 → 2026-09-21)
| event | count |
|---|---|
| DELISTED_FROM_MAP | 43811 |
| EXCHANGE_CHANGED | 7 |
| LISTED | 48015 |
| NAME_CHANGED | 9036 |
| SYMBOL_CHANGED | 3399 |
...
## What a "removal" is
`events.parquet` has 43811 raw `DELISTED_FROM_MAP` rows. **50% of
...
Of the removals that are neither re-listed nor suspect (14358),
...
over the remaining 12493 true delistings. The raw rows stay in `events.parquet`; nothing is deleted.
